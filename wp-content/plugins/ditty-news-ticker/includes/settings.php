...
function mtphr_dnt_settings_menu() {
	...
	add_submenu_page(
		...
		'تنظیمات',									// The value used to populate the browser's title bar when the menu page is active
		'تنظیمات',									// The label of this submenu item displayed in the menu
