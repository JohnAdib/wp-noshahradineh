...
function mtphr_dnt_widget() {
	...
	$widget_ops = array(
		...
		'description' => 'نمایش نوار خبری ثبت شده'
	);
	...
	// Create the widget
	$this->WP_Widget( 'mtphr-dnt-widget', 'نوار خبری', $widget_ops, $control_ops );
}
...
function form( $instance ) {
  ...
  <!-- Ticker: Select -->
	<p>
		<label for="<?php echo $this->get_field_id( 'ticker' ); ?>">یک نوار خبری را برگزینید</label><br/>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id( 'ticker_title' ); ?>">نمایش عنوان نوار خبری</label>
	</p>
