...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
      ...
      add_theme_page("تنظیمات پوسته فارینوس", " تنظیمات پوسته", 'edit_themes', basename(__FILE__), 'mytheme_admin');
...
<p style="text-align:right;"> <small> سفارشی شده توسط <a href="http://www.serena.ir/">گروه سرنا </a>| <a href="http://www.evazadeh.com">جواد عوض زاده</a> </small>
</div>
<?php
}
